defmodule SamWeb.UserAuthTest do
  use SamWeb.ConnCase, async: true

  alias Sam.Accounts
  alias SamWeb.UserAuth
  import Sam.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SamWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      SamWeb.Endpoint.subscribe(live_socket_id)
